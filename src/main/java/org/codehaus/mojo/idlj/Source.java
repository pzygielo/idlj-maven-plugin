...
/**
 * This class represent the source tag available in the configuration tree of
 * the maven plugin
 * 
...
public class Source {
	...
	/**
	 * @return a <code>Boolean</code> true if and only if the creation of the
	 *         stubs is enabled
	 */
	...
	/**
	 * @return a <code>Boolean</code> true if and only if the creation of
	 *         compatible code is enabled
	 */
	...
	/**
	 * @return the default package name that will be used as for all the
	 *         generated classes
	 */
	...
	/**
	 * @return a <code>List</code> of <code>PackagePrefix</code> to use for the
	 *         generated files
	 */
	...
	/**
	 * @return a <code>List</code> of <code>String</code> that will be added as
	 *         compiler parameters
	 */
